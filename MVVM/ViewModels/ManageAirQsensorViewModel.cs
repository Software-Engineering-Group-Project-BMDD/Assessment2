...
{
    public partial class ManageAirQsensorViewModel : ObservableObject
    {
        ...
        public ManageAirQsensorViewModel()
        {
        ...
        {
            // Save to Assessment2Db.db (implement your own repository or use DatabaseConnectionManager)
            using var conn = DatabaseConnectionManager.GetConnection();
            using var cmd = conn.CreateCommand();
            cmd.CommandText = "INSERT INTO AirSensorConfig (Sensitivity1, Sensitivity2) VALUES (@s1, @s2)";
